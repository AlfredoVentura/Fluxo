...
Versão: 1.0 (levantamento inicial — será consolidado no Checkpoint 2)
...
Origem: entrevista simulada com o usuário-tipo, análise de concorrentes (Nubank, Inter, C6) e requisitos da disciplina.
...
Resumo: 52 requisitos funcionais — 28 Must, 20 Should, 4 Could.

Versão em documento separado, formatada para leitura no GitHub: 
...
Resumo: 39 requisitos não funcionais em 6 categorias.
...
RN05	O valor mínimo de uma transferência é R
0
,
01
e
...
Parte IV — Rastreabilidade Requisito × Caso de Uso
Diagrama	Casos de uso	Requisitos atendidos
